...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-scdefault-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-scdefault-700 transition'
